  ...
  return (
    <div style={{ backgroundColor: theme.bg, minHeight: '100vh', padding: '40px 20px', color: theme.textMain }}>
      <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
        ...
        {user.role === 'admin' && (
          <section style={{
            padding: '50px', background: theme.surface,
            border: `3px solid ${theme.border}`, boxShadow: '15px 15px 0px rgba(0,0,0,0.05)'
          }}>
            <div style={{ marginBottom: '40px', borderBottom: `2px solid ${theme.textMain}`, paddingBottom: '20px' }}>
              <h2 style={{ margin: 0, fontFamily: "'Cormorant Garamond', serif", fontSize: '2rem', textTransform: 'uppercase' }}>
                MEMBER_OPERATIONS
              </h2>
